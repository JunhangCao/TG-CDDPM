...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps):
    ...
    if schedule_name == "linear":
        ...
        # diffusion steps.
        scale = 500 / num_diffusion_timesteps
...
class GaussianDiffusion:
    ...
    def p_sample(
        self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None,
            top_p=None, mask=None, x_start=None, cond_fn=None,
    ):
        """
    ...
    def training_losses_seq2seq(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        input_ids_x = input_ids_x.long()
        # input_ids_mask = model_kwargs.pop('input_mask').to(t.device)
        x_start = model.model.get_input_embeddings()(input_ids_x)

        # x_start = model_kwargs.pop('text_features').to(t.device)
        # ref_start = model_kwargs.pop('pep_features').to(t.device)
        ...
        # terms["nll"] = self._token_discrete_loss(model_out_x_start, get_logits, input_ids_x, truncate=True, t=t) # x_0->model_out_x_start
